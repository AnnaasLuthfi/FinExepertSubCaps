package com.myapps.core.di

import androidx.room.Room
import com.myapps.core.data.SportRepository
import com.myapps.core.data.source.local.LocalDataSource
import com.myapps.core.data.source.local.SportDatabase
...
import java.util.concurrent.TimeUnit
    ...
    val databaseModule = module {
        ...
        single {
            val passphrase: ByteArray = SQLiteDatabase.getBytes("dbsport".toCharArray())
